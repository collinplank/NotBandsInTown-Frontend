  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-purple-600 to-blue-500 text-white">
      <div className="w-full max-w-7xl px-6 py-12 text-center">
        <h1 className="text-5xl font-extrabold mb-6 tracking-tight">Find Your Next Event</h1>
        <p className="text-xl mb-8">Explore the hottest concerts, sports, and events near you</p>
        <div className="flex justify-center mb-8">
          ...
          />
          <button className="ml-4 px-6 py-3 bg-purple-700 text-white rounded-lg hover:bg-purple-800">Search</button>
        </div>
