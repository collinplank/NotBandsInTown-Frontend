export function ArtistsShow({ artist, onUpdate, onDestroy }) {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg space-y-8">
      <h1 className="text-3xl font-bold text-gray-800">Artist Information</h1>

      <div className="bg-gray-50 p-6 rounded-lg shadow-md">
        <h2 className="text-4xl font-extrabold text-gray-800">{artist.name}</h2>
        <p className="text-lg text-gray-500 mb-4">{artist.genre}</p>
        <p className="text-base text-gray-700">{artist.bio}</p>
      </div>
